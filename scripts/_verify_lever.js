...
ok('  25年 100档 增发占比', g(25, 100).ex / g(25, 100).total * 100, 1.96, 0.01)
ok('  25年 300档 增发占比', g(25, 300).ex / g(25, 300).total * 100, 1.66, 0.01)
ok('  30.42年 100档 增发占比', g(30.42, 100).ex / g(30.42, 100).total * 100, 3.85, 0.01)
ok('  30.42年 300档 增发占比', g(30.42, 300).ex / g(30.42, 300).total * 100, 3.33, 0.01)
...
ok('  延年限 剔增发后月领差', dClean, 1457.68, 0.02)
ok('  延年限 剔增发后每万元', dClean / yFee * 10000, 354.97, 0.05)
ok('  延年限 效率降幅', (1 - dClean / dRaw) * 100, 8.4, 0.05)
ok('  剔增发后倍数', (dClean / yFee) / (tRaw / tFee), 5.27, 0.01)
...
ok('  15→20年 每月领/年', segEff[0].dC, 105.01, 0.02)
ok('  20→25年 每月领/年（剔增发）', segEff[1].dC, 92.50, 0.02)
ok('  25→30.42年 每月领/年（剔增发）', segEff[2].dC, 86.74, 0.02)
ok('  每万元效率 15→20年', segEff[0].per10k, 228.4, 0.5)
ok('  每万元效率 20→25年', segEff[1].per10k, 411.8, 0.5)
ok('  每万元效率 25→30.42年', segEff[2].per10k, 686.9, 0.5)
...
for (const y of [15, 25, 30.42]) {
  ...
  ok('  ' + y + '年 100档 性价比', c100 / g(y, 100).fee * 100,
    { 15: 0.985, 25: 1.273, 30.42: 1.438 }[y], 0.001)
  ok('  ' + y + '年 300档 性价比', c300 / g(y, 300).fee * 100,
    { 15: 0.777, 25: 0.979, 30.42: 1.090 }[y], 0.001)
}
ok('  25年提档 剔增发后边际回本', (g(25, 300).fee - g(25, 100).fee) /
  ((g(25, 300).total - ex(25, 300)) - (g(25, 100).total - ex(25, 100))) / 12, 10.02, 0.01)
ok('  30.42年提档 剔增发后边际回本', (g(30.42, 300).fee - g(30.42, 100).fee) /
  ((g(30.42, 300).total - ex(30.42, 300)) - (g(30.42, 100).total - ex(30.42, 100))) / 12, 9.09, 0.01)
