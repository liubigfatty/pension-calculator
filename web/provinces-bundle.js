...
const PROV_BASE = {
  ...
  2023: 9028,
  2024: 9307,
   2025: 9493,  // 2025年计发基数=2024全口径社平(国办发〔2019〕13号口径，官方已发布)
};;
...
const SHENZHEN_BASE = {
  ...
  2025: 11293, // 深圳市人社局2025-11-17：深圳2025企业职工计发基数（粤府核定11293元/月）
};
...
(function () {
  var module = { exports: {} };
  var exports = module.exports;
// 数据来源：2024计发基数8332元/月、2025计发基数8448元/月 已官方确认
//   - 2024计发基数8332 = 2023全口径社平 99986元/年（新人社发函[2024]138号）
//   - 2025计发基数8448 = 2024全口径社平 101381元/年（新人社发[2025]，2025-08-25）
...
const PROV_BASE = {
  ...
  2023: 7625,
  2024: 8332,
   2025: 8448,  // 2025年计发基数=2024全口径社平101381元/年=8448元/月(新人社发[2025]，2025-08-25，官方已发布)
};;
...
const BASE_PARAMS = {
  ...
  PROV_GROWTH: 0.02,  // 预估年增长2%
  MERGE_YEAR: 2031,
  PROV_2025: 8448,  // 2025年计发基数=2024全口径社平101381元/年=8448元/月(新人社发[2025]，2025-08-25)
}
...
base_rates: PROV_BASE,
 ...
 modules: modules,
    ...
    cities: CITY_LIST || [],
    cases: cases || [],
    notes: '2024计发基数8332(新人社发函[2024]138号)、2025计发基数8448(新人社发[2025])已确认；1995-2022历史年表待官方逐年限核',
  }
}
