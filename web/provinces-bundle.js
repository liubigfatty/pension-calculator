...
const PROV_BASE = {
  ...
  2023: 7988,
  2024: 8160,
   2025: 7339,  // 2025年计发基数=2024全口径社平(国办发〔2019〕13号口径，官方已发布)
};;
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 7264.08,
  2024: 8160,
  2025: 7339,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 9283.42,
  2024: 7776,
  2025: 7535,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const PROV_BASE = {
  ...
  2023: 7359,
  2024: 7594,
   2025: 7338,  // 2025年计发基数=2024全口径社平(国办发〔2019〕13号口径，官方已发布)
};;
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 6861,
  2024: 7194,
  2025: 7338,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 9167,
  2024: 9307,
  2025: 9183,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 6755.83,
  2024: 6847,
  2025: 6905,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 7272.25,
  2024: 7272,
  2025: 7324.5,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const AVG_SALARY_HISTORY = {
  ...
  2022: 7490,
  2023: 8014,
  2024: 8132,  // 2024年度缴费基数·2023全口径社平（江苏税务2024-10-08：上限24396/下限4879→4879÷0.6=8132）
  2025: 8254,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const PROV_BASE = {
  ...
  2023: 6747,
  2024: 6916,
   2025: 6525,  // 2025年计发基数=2024全口径社平(国办发〔2019〕13号口径，官方已发布)
};;
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 6098,
  2024: 6397,
  2025: 6525,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 7121,
  2024: 7201,
  2025: 7264,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const PROV_BASE = {
  ...
  2023: 7489,
  2024: 7727,
   2025: 7727,  // 2025年计发基数尚未公布，2025年退休预发暂用2024年基数7727
};;
...
base_rates: PROV_BASE,
 ...
 modules: modules,
    ...
    cities: CITY_LIST || [],
    cases: cases || [],
    notes: '2024年计发基数7727元。2025年计发基数尚未公布，2025年退休预发暂用2024年基数7727，待公布后重新核算。过渡系数1.4%；过渡性养老金=本人指数化月平均工资×视同缴费年限×1.4%，只用视同缴费年限（参加工作之日至1992-12-31），不用建账前年限。',
  }
}
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 7598.33,
  2024: 7727,
  2025: 7750,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const PROV_BASE = {
  ...
  2023: 6897,
  2024: 7111,
   2025: 6997,  // 2025年计发基数=2024全口径社平(国办发〔2019〕13号口径，官方已发布)
};;
...
const BASE_PARAMS = {
  ...
  PROV_GROWTH: 0.02,  // 预估年增长2%
  MERGE_YEAR: 2031,
  PROV_2025: 6997,  // 2025年计发基数=2024全口径社平(国办发〔2019〕13号口径，官方已发布)
}
...
const AVG_SALARY_HISTORY = {
  ...
  // 2025=7253 取自本文件注释「2025年基数7253元（晋人社厅发〔2025〕36号）」，即官方发布的2025年值。
  1992: 210.83,
  1993: 252.08,
  1994: 333.08,
  1995: 393.42,
...
const PROV_BASE = {
  ...
  2034: 10780,
  2035: 11049,
   2025: 7646,  // 2025年计发基数=2024全口径社平(国办发〔2019〕13号口径，官方已发布)
};;
...
// 2025年计发基数：7646元（=2024全口径社平，国办发〔2019〕13号口径，官方已发布）
const BASE_PARAMS = {
  
  PROV_GROWTH: 0.050,  // 约 5.0%/年
  MERGE_YEAR: 2031,
  PROV_2025: 7646,  // 2025年计发基数=2024全口径社平(国办发〔2019〕13号口径，官方已发布)
}
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 7518.33,
  2024: 8332,
  2025: 7646,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 8355,
  2024: 9232,
  2025: 8540,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 8332,
  2024: 8321,
  2025: 8448,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const AVG_SALARY_HISTORY = {
  ...
  2018: 7587,
  2019: 7815,
  2020: 8143,       // ✅ 核验表 97716÷12（原8839❌错位）
...
const PROV_BASE = {
  ...
  2023: 8023,
  2024: 8183,
   2025: 7263,  // 2025年计发基数=2024全口径社平(国办发〔2019〕13号口径，官方已发布)
};;
...
const BASE_PARAMS = {
  ...
  PROV_2025: 7263,  // 2025年计发基数=2024全口径社平(国办发〔2019〕13号口径，官方已发布)
}
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 7177,
  2024: 8183,
  2025: 7263,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
const AVG_SALARY_HISTORY = {
  ...
  2023: 8310.17,
  2024: 8310,
  2025: 8433,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
