...
const AVG_SALARY_HISTORY = {
  1996: 685.83,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1997: 685.83,
  1998: 1321,
  1999: 1258,
  2000: 1321,
  ...
  2024: 7044.38,
  2025: 7185,
  // [V2已删] 2025: 7426,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
  2026: 7257,   // 2025年统计口径社平（2026年度执行）
};
...
const PROV_BASE = {
  ...
  2017: 8374.36,
  2018: 7855,
  2019: 8847,  // 订正:rsj.beijing.gov.cn历年全口径表(2025-09-18)2019年全口径月均8847;原9262为旧口径
  2020: 9910,
  2021: 10534,
  2022: 11082,
  2023: 11525,
...
// 【时间标记核验 2026-07-23】AVG 2018-2024 全口径月均=7855/8847/9407/10628/11297/11761/11937,
//   经北京市人社局 rsj.beijing.gov.cn《历年北京市全口径城镇单位就业人员平均工资》(2025-09-18)逐年代确认✅
//   (2019由旧值9262订正为8847)。1995-2017为城镇非私营单位就业人员月均(口径切换前),量级偏高属正常。
//   计发基数PROV_BASE(11883/12049)与全口径社平(11937)为两套数,详见文章社平表/计发基数表分列。
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1995: 608,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1996: 608,
  1997: 701.92,
  1998: 754.08,
  1999: 769.92,
  ...
  2024: 11761,
  2025: 11937,
  2026: 12116,   // 2025年统计口径社平（2026年度执行）
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1991: 275,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1992: 275,
  1993: 220.75,
  1994: 262.08,
  1995: 355.17,
  ...
  2024: 7264.08,
  2025: 7339,
  2026: 7588.33,   // 2025年统计口径社平（2026年度执行）
  // 2025: 官方全口径未公布，交由引擎预发年规则外推(=2024原值)，公布后再填
};
...
// 福建省养老金计算数据模块
// PROV_BASE 时间标记：2023-2025 来自官方（2023=7528/2024=7776/2025=7932，闽人社规+核定表佐证）；1978-2022 为推定（1998-2019=复制社平AVG，2020-2022 无源更高值待官方）
// 依据：闽人社规〔2024〕?号、闽人社规〔2025〕?号

// ==================== 基础数据 ====================

// 福建省历年计发基数（元/月）
// PROV_BASE 时间标记：2023-2025 来自官方(7776/7932；7528)，1978-2022 推定（1998-2019=社平复制，2020-2022 无源）
const PROV_BASE = {
  1978: 824,
  1979: 865,
  1980: 909,
...
// 闽政[1996]13号《福建省企业职工养老保险制度改革方案》确定从1996年1月起建立个人账户（南平市人社局政策宣传页、闽政〔2006〕24号、闽劳社文〔2004〕284号确认）；视同缴费截止1995-12
const ACCOUNT_START = { year: 1996, month: 1 }
const CUTOFF_DATE   = { year: 1995, month: 12 }
...
// 历年社平工资（元/月）—— 用于个人账户余额精确计算
// AVG 时间标记：1998-2025 与官方核定表/统计年鉴一致（元/月，2025-07 校验；比对《福建省社平工资》MD 逐年吻合）；1978-1997 为占位推定（MD 明示"1998年前为占位值待官方确认"）
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1978: 47.17,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1979: 47.17,
  1980: 49.42,
  1981: 55.67,
  1982: 58,
  ...
  2024: 7388,
  2025: 7535,
  // [V2已删] 2025: 7770,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
  2026: 7631,   // 2025年统计口径社平（2026年度执行）
};
...
const BASE_PARAMS = {
  ...
  account_start: 1996,
  trans_coef: 0.012,
  PROV_2025: 7746,  // 2025年计发基数=7746（2026-01退休核定表确认；纠正原误填2024全口径社平7338，同类津/陕/黔/青bug）
}
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1995: 457.75,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1996: 457.75,
  1997: 490.17,
  1998: 515.17,
  1999: 534.83,
  ...
  2024: 7194,
  2025: 7338,
  // [V2已删] 2025: 7729,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
  2026: 7542,   // 2025年统计口径社平（2026年度执行）
};
...
// ⚠️ 2021–2024 深圳社平：官方社保年度表未公布。"由深圳计发基数倒推"假设不成立（深圳2020社平9309 ≠ 2021计发基数10360，证伪"计发基数=上年社平"），
//    下方数值为占位估算、非官方值，仅供引擎不报错；禁止作文中引用，待深圳官方社保年度社平公布后替换。
// 【数据校正 2026-08-11】深圳独立社平：✅ 1990-2020 用户官方表(2026-07-21)；⚠️ 2021-2024 为占位估算，非官方。
const SHENZHEN_AVG_SALARY = {
  ...
  // ⚠️ 以下2021–2024为占位估算（原"由深圳计发基数倒推"，但深圳证伪该假设），非官方值，禁用作文中引用
  2021: 10795,
  2022: 10795,
  2023: 11181,
  2024: 11293,
...
const TRANS_COEF = 0.012  // 广东过渡系数全省固定 1.2%（粤府〔2006〕96号 统一规定，不分市县）；与甘肃/黑龙江/湖北/江苏/内蒙古/上海同属1.2%档（31省中7省）
...
// 【数据校正 2026-08-11】广东全省社平(AVG_SALARY_HISTORY.prov,元/月)=缴费指数分母，按官方口径重填：
//   1994-1997：全省职工月平均工资（粤府〔2006〕96号 附表，出自历年《广东统计年鉴》）
//   1998-2017：全省在岗职工月平均工资（同上；2017年在岗年工资80020÷12=6668）
//   2018-2024：全省全口径城镇单位就业人员月平均工资（省统计局留言 + 粤人社发〔2019〕93号/〔2023〕22号/〔2024〕33号/〔2025〕32号；2024=9183）
//   ⚠️ 2018口径切换断点：全口径6338 低于 2017在岗6668，因纳入私营单位拉低均值，属正常断点非数据错误。
//   ⚠️ 旧值(529/1031.17/3016.92/6711.58/6320.17/6524.5…)为混用"职工/在岗"两列+早期平滑外推，已作废。
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  prov: {
    1994: 593,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
    1995: 593,
    1996: 688,
    1997: 761,
    1998: 808,
    ...
    2024: 9167,
    2025: 9183,
    // 2025: 官方全口径未公布，交由引擎预发年规则外推，公布后再填
  },
...
(function () {
  var module = { exports: {} };
  var exports = module.exports;
// 数据来源：✅ 部分已核（2022/2024/2025 官方核定表核对通过；2023=6629 已核·桂人社发〔2023〕85号；1978-2021 早年段占位，已免责）
// 2024年计发基数：6847元/月
// 更新时间：2026-06-10
...
// 广西壮族自治区养老金计算模块
// TODO：补充1995-2021年官方计发基数（2022/2024/2025/2023已核：6442/6847/6983/6629；2023依桂人社发〔2023〕85号）

// ==================== 计发基数 ====================
// 【时间标记核验 2026-07-23】广西计发基数（元/月）：规则≈省加权公布值（PROV_BASE[2025]=6983 vs AVG[2024]=6905 印证非简单"上年社平"）
//   ✅ 2022/2024/2025：MD 案例佐证(柳州2022=6442、南宁2025预发2024=6847、桂林2026预发2025=6983)
//   ⚠️ 2023=6629：引擎值，MD 未明确出现，待官方核实；1978-2021：推定占位(平滑外推)，MD 无历年表
const PROV_BASE = {
  1978: 726,
  1979: 762,
  1980: 800,
  ...
  2023: 6629,
  2024: 6847,
   2025: 6983,  // ✅ 2025年计发基数=6983(已公布，桂林2026退按此预发；非"=2024全口径社平")
};;
...
const BASE_PARAMS = {
  ...
  PROV_GROWTH: 0.02,  // 预估年增长2%
  MERGE_YEAR: 2031,
  PROV_2025: 6905,  // 2024年全口径社平=6905(元/月)；2025计发基数见PROV_BASE[2025]=6983
}
...
base_rates: PROV_BASE,
 ...
 modules: modules,
    ...
    cities: CITY_LIST || [],
    cases: cases || [],
    notes: '2023年基数已确认=6629(桂人社发〔2023〕85号；2024-2025已核:6847/6983；建账前实际缴费计入过渡性,见分进角)',
  }
}

// ==================== 导出 ====================

// 【时间标记核验 2026-07-23】广西社平(AVG_SALARY_HISTORY,元/月)：✅ 1996-2024 与 MD 社平表逐值吻合(449.75…6905，含2020口径切换5819)；⚠️ 1995=425.42 引擎多一年(建账前)，MD表自1996起列示，标推定
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1995: 425.42,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1996: 425.42,
  1997: 449.75,
  1998: 461.67,
  1999: 517.33,
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1990: 162.25,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1991: 162.25,    // 1947/年（贵州统计局·非私营在岗）
  1992: 174.17,    // 2090/年
  1993: 200.50,    // 2406/年
  1994: 235.25,    // 2823/年
  1995: 322.50,    // 3870/年
  ...
  1997: 409.75,    // 4917/年
  1998: 433.83,    // 5206/年
  1999: 481.25,    // 5775/年（建账年，非私营在岗）
  2000: 549.58,    // 6595/年
  2001: 621.08,    // 7453/年
  2002: 749.25,    // 8991/年
  2003: 817.50,    // 9810/年
  2004: 919.75,    // 11037/年
  2005: 1035.92,   // 12431/年
  2006: 1195.33,   // 14344/年
  2007: 1401.25,   // 16815/年
  2008: 1722.33,   // 20668/年
  2009: 2050.17,   // 24602/年
  2010: 2353.75,   // 28245/年
  2011: 2621.50,   // 31458/年
  2012: 3110.92,   // 37331/年
  2013: 3561.08,   // 42733/年
  2014: 4090.58,   // 49087/年
  2015: 4557.08,   // 54685/年
  2016: 5215.92,   // 62591/年
  2017: 5806.50,   // 69678/年
  2018: 6259.08,   // 75109/年（非私营在岗，贵州统计局/华经）
  2019: 5836.33,   // 70036/年（省政府公报在岗，同比+8.5%；注：当年统计口径微调）
  ...
  2024: 7272.25,
  2025: 7324.5,
  // [V2已删] 2025: 7376.75,  // ✅ 已核：2025全口径社平 88521元(黔人社等四部门 2026-07-08公布)÷12
  2026: 7376.75,   // 2025年统计口径社平（2026年度执行）
};
...
(function () {
  var module = { exports: {} };
  var exports = module.exports;
// 数据来源：✅ 已据官方核定表核实（近年官方值已确认；早年段为引擎推算占位，已免责）
// 2024年计发基数：8131元/月
// 更新时间：2026-06-10
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1998: 520,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1999: 520,
  2000: 572,
  2001: 617,
  2002: 693,
...
(function () {
  var module = { exports: {} };
  var exports = module.exports;
// 数据来源：✅ 已据官方核定表核实（2025 预发基数经 2026-01 退休核定表确认；早年段见内层占位说明）
// 2024年计发基数：7010元/月
// 更新时间：2026-06-10
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1990: 154.17,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1991: 154.17,
  1992: 172.5,
  1993: 191,
  1994: 222,
  ...
  2025: 7570,
  // [V2已删] 2025: 7705,
  2026: 7705,   // 2025年统计口径社平（2026年度执行）
};
...
(function () {
  var module = { exports: {} };
  var exports = module.exports;
// 数据来源：✅ 官方数据（豫人社发〔2025〕67号 + 腾讯/搜狐真实核定表交叉验证）
// 2024年计发基数：6606元/月；2025年计发基数：6738元/月
// 更新时间：2026-07-23
...
// 【时间标记核验 2026-07-23】对照 articles/河南省社平工资-现实调音师.md + 官网/核定表
//   PROV_BASE 2023=6401/2024=6606/2025=6738：全省计发基数，已逐年限核官网/真实核定表 ✅已核
//     (2024=6606见腾讯新闻2025-05-12；2025=6738见搜狐2025/腾讯核定表；2023=6401真实表验证)
//   PROV_BASE 1978-2022：平滑外推占位（TODO 补充1995-2022官方计发基数）📋占位
//   PROV_BASE 2026=6738：2026退休暂用2025基数预发（2026官方未公布；网传7850为不实猜测）
//   数值未改。

// 河南省历年计发基数（元/月）
// 2023-2025来自官方核定表/豫人社发（已验证），其余年份待补充
const PROV_BASE = {
  1978: 714,
  1979: 750,
  1980: 787,
...
// 洛阳市单独计发基数（2023年6457元，洛阳市社保局问政公开回复确认；2024/2025=6573 已确认=2025洛阳地方计发基数，腾讯新闻2026-07-09/洛阳国企核定表实测）
...
const TRANS_COEF = 0.013  // 河南过渡系数 1.3%（豫政[2006]29号；搜狐2025-07核实："乘以1.3%(河南省确定的过渡性系数)"）
...
// 【时间标记核验 2026-07-23】对照 articles/河南省社平工资-现实调音师.md 官方社平年表
//   AVG 1995-2024：与MD社平年表逐值吻合(引擎取小数更精确，2020-2024完全精确：5328/5681/5965/6260/6385) ✅已核
//   AVG 2025：未公布，引擎预发外推(=2024原值)，待官方公布 📋占位
//   数值未改。

// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1995: 362,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1996: 362,
  1997: 410.33,
  1998: 435.42,
  1999: 470.08,
  ...
  2023: 5965,
  2024: 6260,
  2025: 6385,  // 2024年全省全口径社平（豫人社发及真实表验证）
  // 2025: 官方全口径未公布，交由引擎预发年规则外推(=2024原值)，公布后再填
};
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1998: 706,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1999: 706,
  2000: 734,
  2001: 811,
  2002: 943,
...
(function () {
  ...
  var exports = module.exports;
// 数据来源：✅ 官方数据（三张核定表）
// 2023年计发基数：7417元/月（湖南女2024-09退休按2023基数预发确认）；2024=7618、2025=7694
...
// ==================== 基础数据 ====================
// 【时间标记核验 2026-07-23】湖南计发基数（元/月）
//   ✅ 2023-2025：与 MD 附表一+三张核定表一致(7417/7618/7694)
//   ⚠️ 1995-2022：推定（MD 无历年计发基数表；与缴费基准值序列衔接）
//   📋 1978-1994：高值占位；⚠️ 1994(1780)→1995(342) 量级断崖(约10倍)，疑似两段拼接，待官方核
const PROV_BASE = {
  1978: 816,
  1979: 856,
  1980: 899,
...
// 【时间标记核验 2026-07-23】湖南社平/缴费基准值(AVG_SALARY_HISTORY,元/月)：✅ 1995-2025 与 MD 附表二缴费基准值逐值对应(引擎Y=MD Y-1，社保年度vs自然年映射；含2020实测5054/2025实测6787)；⚠️ 1990-1994 引擎多5年(MD自1995起)，标推定
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1990: 169.83,
  1991: 181.42,
  ...
  2026: 6843,   // 2025年统计口径社平（2026年度执行）
};
...
const AVG_SALARY_HISTORY = {
  ...
  1995: 495.25,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1996: 495.25,  // =5943÷12（1996年度基数）
  1997: 550.25,  // =6603÷12（1997年度基数）
  1998: 592.33,  // =7108÷12（1998年度基数）
  1999: 688,     // =8256÷12（1999年度基数）
  2000: 764.25,  // =9171÷12（2000年度基数）
  2001: 759.17,  // =9110÷12（2001年度基数 9110 元/年；原 858 系反推值，偏高 13%，2026-09-08 订正）
  2002: 986.83,  // =11842÷12（2002年度基数）
  2003: 1125.75, // =13509÷12（2003年度基数）
  2004: 1309.33, // =15712÷12（2004年度基数）
  2005: 1516.83, // =18202÷12（苏劳社险[2005]6号锚点）
  2006: 1746.42, // =20957÷12（2006年度基数）
  2007: 1981.83, // =23782÷12（2007年度基数）
  2008: 2281.17, // =27374÷12（2008年度基数）
  2009: 2638.92, // =31667÷12（2009年度基数）
  2010: 2990.83, // =35890÷12（苏人社发[2010]316号锚点）
  2011: 3375.42, // =40505÷12（2011年度基数）
  2012: 3832.25, // =45987÷12（2012年度基数）
  2013: 4273.25, // =51279÷12（2013年度基数）
  2014: 4832.08, // =57985÷12（苏人社发[2014]255号锚点）
  2015: 5148.58, // =61783÷12（2015年度基数）
  2016: 5600,    // =67200÷12（2016年度基数，2016年度上限16800=5600×3）
  2017: 6057,    // =72684÷12（2017年度基数）
  2018: 6645.08, // =79741÷12（2018年度基数）
  2019: 7215.83, // =86590÷12（2019年度基数，非私营在岗口径最后一年）
  ...
  2020: 6445.08,  // =77341÷12（2020年度指数基数 77341 元/年）
  2021: 6862,     // =82344÷12（2021年度指数基数 82344 元/年）
  2022: 7490,     // =89880÷12（苏人社函〔2022〕334号：2022年度指数基数 89880，上限 22470=7490×3）
  2023: 7839.17,  // =94070÷12（苏人社发〔2023〕62号：2023年度指数基数 94070；24042 系暂定上限已废止）
  2024: 8132,     // =24396÷3（苏税发〔2025〕2号：2025年申报暂按2024年度上限24396/下限4879，4879÷0.6=8132）
  2025: 8254,     // =24762÷3（苏人社发〔2025〕33号：2025年度上限24762/下限4952，4952÷0.6≈8254）
...
// ==================== 计发基数 ====================
// 【时间标记核验 2026-07-23】江西计发基数（元/月）
//   ✅ 2020-2025：与 notes+MD一致(6000/6306/6569/6747/6916/7054)，全口径过渡值(与社平分轨)
//   ⚠️ 1995-2019：引擎沿用 AVG(非私营社平,"2020前计发基数≈社平"近似)，标推定
//   📋 1978-1994：建账前外推占位；⚠️ 1978-1990(733-1316)与1991+(153-350)量级断崖(约10倍)，疑似两段错位拼接，待官方逐核
const PROV_BASE = {
  1978: 733,
  1979: 770,
  1980: 808,
  ...
  2023: 6747,
  2024: 6916,
   2025: 7054,  // ✅ 2025年计发基数=7054(全口径过渡值,独立公布;非"=2024全口径社平6525")
};;
...
const BASE_PARAMS = {
  ...
  PROV_GROWTH: 0.02,  // 预估年增长2%
  MERGE_YEAR: 2031,
  PROV_2025: 6525,  // 2024年全口径社平=6525(元/月)；2025计发基数见PROV_BASE[2025]=7054
}
...
// 【时间标记核验 2026-07-23】江西社平(AVG_SALARY_HISTORY,元/月)：✅ 1995-2025 与 MD 表逐值吻合(350.92…6723，含2020全口径切换5548)；⚠️ 1991-1994 引擎多4年(MD自1995起列示)，标推定
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1991: 153.5,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1992: 153.5,
  1993: 179.5,
  1994: 208.08,
  1995: 287.5,
  ...
  2024: 6397,
  2025: 6525,
  // [V2已删] 2025: 6723,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1995: 369.17,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1996: 369.17,
  1997: 447.5,
  1998: 472,
  1999: 545.92,
  ...
  2024: 7178.5,
  2025: 7322,
  2026: 7481.5,   // 2025年统计口径社平（2026年度执行）
  // 2025: 官方全口径未公布，交由引擎预发年规则外推(=2024原值)，公布后再填
};
...
// 建账时间（个人账户制度建立时间）
// 辽宁省建账时间：辽政发〔1996〕1号"从1996年1月起建立基本养老保险个人帐户"（辽劳字〔1998〕51号重申）；1998-01为并轨国家统一制度日期，非建账时间；视同缴费截止1995-12
const ACCOUNT_START = { year: 1996, month: 1 }
const CUTOFF_DATE   = { year: 1995, month: 12 }
...
const cases = [
  ...
  // 案例4：全省男60岁2023.08退休
  {
    ...
    notes: "辽宁男60岁2023.08退休。省建账1996-01（辽政发〔1996〕1号），1998-01为并轨日期；本核定表建账前15.25年(1982.10起)为个案记录。视同15.25年。单指数（过渡性养老金用平均缴费指数）。⚠️增发339.25表上未显示",
  }
]
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1990: 114.25,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1991: 114.25,
  1992: 119.92,
  1993: 125.92,
  1994: 1587,
  ...
  2025: 7265,
  2026: 7555,   // 2025年统计口径社平（2026年度执行）
  // 2025: 官方全口径未公布，交由引擎预发年规则外推(=2024原值)，公布后再填
};
...
// 【时间标记核验 2026-07-23】PROV_BASE 2021-2024=6803/7089/7469/8105 经内人社办发〔2024〕152号+案例1核定表确认✅；2025=8179 经内人社办发〔2025〕160号(2024全口径8179)确认✅；内蒙古计发基数=上年社平(2023/2024/2025逐代吻合)。
...
const PROV_BASE = {
  ...
  2023: 7469,
  2024: 8105,
   2025: 8179,  // 2025年计发基数=2024全口径社平8179（内人社办发〔2025〕160号：2024全口径月均8179；内蒙古计发基数=上年社平规则）
};;
...
const BASE_PARAMS = {
  ...
  PROV_GROWTH: 0.02,  // 预估年增长2%
  MERGE_YEAR: 2031,
  PROV_2025: 8179,  // 2025年计发基数=2024全口径社平8179（内人社办发〔2025〕160号确认，非预发）
}
...
// 【时间标记核验 2026-07-23】AVG 2020-2024 全口径月均=6344/6751/7469/8105/8179，经内人社办发〔2021-2025〕系列缴费基数通知逐年代确认✅(2020=76126÷12、2021=81017÷12、2022=内人社办发〔2023〕140号、2023=内人社办发〔2024〕136号、2024=内人社办发〔2025〕160号)。1996-2019为城镇非私营单位就业人员月均(内蒙古统计局年表÷12)，用于个人账户精算；2020起切换全口径，量级低于非私营属正常。
// 历年社平工资（元/月）—— 用于个人账户余额精确计算
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1990: 153.83,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1991: 153.83,
  1992: 167.67,
  1993: 194.92,
  1994: 233,
  ...
  2024: 8105,
  2025: 8179,
  // [V2已删] 2025: 8430,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
  2026: 8430,   // 2025年统计口径社平（2026年度执行）
};
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1995: 469.58,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1996: 469.58,
  1997: 506.25,
  1998: 568.5,
  1999: 629.17,
  ...
  2024: 8088,
  2025: 8258,
  // [V2已删] 2025: 8574,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
  2026: 8371,   // 2025年统计口径社平（2026年度执行）
};
...
const PROV_BASE = {
  ...
  2023: 8591,
  2024: 8878,
   2025: 9056,  // 2025年计发基数=9056(青人社厅发〔2025〕69号,2025-09-19官方公布;注意≠缴费基数/社平8816)
};;
...
const BASE_PARAMS = {
  ...
  PROV_GROWTH: 0.02,  // 预估年增长2%
  MERGE_YEAR: 2031,
  PROV_2025: 9056,  // 2025年计发基数=9056(青人社厅发〔2025〕69号官方公布;原8816系缴费基数/社平,非计发基数)
}
...
// 建账时间（个人账户制度建立时间）
// 青海省企业职工基本养老保险个人账户统一建账时间：1996年1月1日（用户官方确认）
const ACCOUNT_START = { year: 1996, month: 1 }
const CUTOFF_DATE   = { year: 1995, month: 12 }
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1995: 479.42,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1996: 479.42,
  1997: 557.25,
  1998: 590.92,
  1999: 667.58,
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1992: 212.08,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1993: 212.08,
  1994: 240.83,   // 2890元/年 ÷12，陕西全省在岗职工年工资
  1995: 316.92,   // 3803元/年 ÷12
  1996: 366.33,
  1997: 406.83,
  1998: 473.67,
  1999: 502.42,
  ...
  2006: 1233,
  2007: 1409.83,
  2008: 1782.58,  // 21391元/年 ÷12，按核定表附表修正
  2009: 2115.92,
  2010: 2524.42,
  2011: 2858.25,
  2012: 3253.58,
  ...
  2024: 7598,
  2025: 7750,
  // [V2已删] 2025: 8031,  // ✅ 2025全口径社平=8031（2026-06-25 公布，涨幅3.62%；非"2024全口径"，2024全口径=7750）
  2026: 7895,   // 2025年统计口径社平（2026年度执行）
};
...
const AVG_SALARY_HISTORY = {
  ...
  1996: 484.08,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1997: 484.08,     // 5809÷12  ✅滕州人社局省表(年鉴在岗5809吻合)
  1998: 520.08,     // 6241÷12  ✅
  1999: 531,        // 6372÷12  ✅省人社口径(年鉴统计口径6800，社保取人社口径)
  2000: 583.08,     // 6997÷12  ✅
  2001: 664.67,     // 7976÷12  ✅
  2002: 750,        // 9000÷12  ✅
  2003: 849.92,     // 10199÷12 ✅
  2004: 949,        // 11388÷12 ✅
  2005: 1091.42,    // 13097÷12 ✅
  2006: 1294.17,    // 15530÷12 ✅(同年在岗16614)
  2007: 1602.33,    // 19228÷12 ✅(社平=在岗同值)
  2008: 1806.42,    // 21677÷12 ✅(同年在岗22844；原引擎误取在岗列)
  2009: 2107.42,    // 25289÷12 ✅(同年在岗26404；原误取在岗列)
  2010: 2474,       // 29688÷12 ✅(社平=在岗同值)
  2011: 2810.75,    // 33729÷12 ✅(社平=在岗同值)
  2012: 3134.83,    // 37618÷12 ✅(同年在岗37992；原误取在岗列，年鉴合计37618吻合)
  2013: 3492,       // 41904÷12 ✅(同年在岗42572；原误取在岗列)
  2014: 3916.5,     // 46998÷12 ✅(同年在岗47652)
  2015: 4318.75,    // 51825÷12 ✅(同年在岗52460)
  2016: 4772.5,     // 57270÷12 ✅(同年在岗58197)
  2017: 5211.58,    // 62539÷12 ✅(同年在岗63562)
  2018: 5673.42,    // 68081÷12 ✅(同年在岗69305)
  // ===== 新口径：全省全口径城镇单位就业人员平均工资（2018起并轨）=====
  2019: 5448.58,    // 65383÷12 ✅滕州人社局省表(省全口径)
  2020: 5761.33,    // 69136÷12 ✅滕州人社局省表(省全口径)
  2021: 6242.17,    // 74906÷12 ✅鲁人社字〔2021〕131号
  2022: 6633.08,    // 79597÷12 ✅鲁人社字〔2022〕89号
  2023: 7069.25,    // 84831÷12 ✅鲁人社字〔2023〕59号(淄博鲁人社字〔2023〕134号复述"7069元"印证)
  2024: 7359.42,    // 88313÷12 ✅鲁人社字〔2024〕64号(济南/烟台/济宁转发文复述"7359元"印证)
  2025: 7506,       // 90072÷12 ✅2024全口径(省统计局2025-07-03；非私营108131/在岗110732/私营61196)
  // [V2已删] 2025: 7774,       // 🔮外推预测值(≈7506×1.036)；2025官方全口径截至2026-08未公布，非官方
  2026: 7621,   // 2025年统计口径社平（2026年度执行）
};
...
const AVG_SALARY_HISTORY = {
  ...
  1990: 246.96,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1991: 246.96,  // 推定(旧口径，国家统计局市区职工平均工资)
  1992: 287.00,  // 推定(旧口径)
  1993: 364.03,  // 推定(旧口径)
  1994: 483.06,  // 推定(旧口径)
  1995: 630.93,  // 推定(旧口径)
  1996: 773,     // ✅ 官方(沪劳综发〔1996〕48号:1995年度全市职工月平均工资773元)
  1997: 3139,
  1998: 3296,
  1999: 3461,
  2000: 3634,
  ...
  2024: 12307,
  2025: 12434,
  2026: 12577,   // 2025年统计口径社平（2026年度执行）
  // 2025: 官方全口径未公布，交由引擎预发年规则外推(=2024原值)，公布后再填
};
...
const AVG_SALARY_HISTORY = {
  ...
  1992: 210.83,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1993: 210.83,
  1994: 252.08,
  1995: 333.08,
  1996: 393.42,
  ...
  2017: 4581,
  2018: 5129,
  2019: 4656,  // 2018年山西切入全口径(官方表标注全口径),与第二列4656一致

  2020: 4832,    // 官方表(图3)第二列2019社平=4832(原5392.33系与2020重复,已修正)

  2021: 5392.33, // 官方表第二列2020社平=5392,吻合
  2022: 5914,
  2023: 6438.08,
  2024: 6854.58,
  2025: 6997,
  // [V2已删] 2025: 6997,  // 2025年缴费基数=6997元/月（晋人社厅发〔2025〕35号），即2025年度社平/缴费基数
  2026: 7073,   // 2025年统计口径社平（2026年度执行）
};
...
(function () {
  var module = { exports: {} };
  var exports = module.exports;
// 数据来源：✅ 已据官方核定表核实（2023-2025 经真实核定表验证；1996-2012 外推估算占位，已免责）
// 2024年计发基数：8321元/月
// 更新时间：2026-06-10
...
// 【时间标记核验 2026-07-23】对照 articles/四川省社平工资-现实调音师.md 官方年表：
//   ✅ 2023-2025：经真实核定表验证（8079/8321/8462），与 cases baseRetire 一致
//   📋 1996-2022：MD计发基数表逐值一致，但MD自述1996-2012=估算待核实、2013-2022=用户提供工资数据（非官方计发基数表）
//   ⚠️ 1978-1995：建账前（1996建账）外推占位，不参与实际计算
//   🔮 2027-2035：按PROV_GROWTH 5%外推预测值，非官方
const PROV_BASE = {
  1978: 882,
  1979: 926,
  1980: 972,
...
// 2023年月平均工资：7518.33元
// 2024年全口径社平：7646元（=AVG[2024]）；✅已核实：2024全口径=91752元（川人社办发〔2025〕39号），÷12=7646，引擎正确；MD第三节"约7894"为5%外推参考值，无官方依据，错误
// 2025年全口径社平：7646元（官方未公布，暂沿用2024值，预发）；2025计发基数见PROV_BASE[2025]=8462
const BASE_PARAMS = {
  
  PROV_GROWTH: 0.050,  // 约 5.0%/年
  MERGE_YEAR: 2031,
  PROV_2025: 7646,  // 2025全口径社平未公布，暂=AVG[2024]=7646（预发）；真实值待官方公布
}
...
// 【时间标记核验 2026-08-05】建账以来(1996–2024)社平全口径核对：
//   ⚠️ 口径切换：1996–2018 为"城镇非私营单位在岗职工平均工资"（当时缴费/计发依据）；
//       2019 年起国家改按"全口径城镇单位就业人员平均工资"核定（缴费新依据）。两口径不可直接比增速。
//   ✅ 旧口径 1996–2018：国家统计局《在岗职工平均工资_四川省》(hexun转发)1996–2010 + 内江市政府转发《四川省及内江市职工平均工资通知》(省统计局)2011–2019非私营列，元/年÷12。
//   ✅ 全口径 2019(69267)–2024(91752)：2019–2022 内江PDF全部单位列；2023 川人社办发〔2024〕48号(90220)；2024 川人社办发〔2025〕39号(91752)。
//   🔮 2025：官方全口径未公布，引擎预发年规则外推(=2024原值7646)。
//   注：原 1995–2019 与 PROV_BASE 同值为外推占位(已废除)；本段为核实后真实社平。
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1995: 2022,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1996: 2022,      // 建账前占位(原PROV_BASE同值)，建账以来数据自1996起；待官方核实
  // —— 旧口径：城镇非私营单位在岗职工平均工资（元/月 = 年值÷12）——
  1997: 429.67,    // 5156/年（非私营在岗，国家统计局）
  1998: 468.83,    // 5626
  1999: 548.08,    // 6577
  2000: 604.08,    // 7249
  2001: 693.58,    // 8323
  ...
  2017: 5481.75,   // 65781
  2018: 5969.25,   // 71631
  2019: 6705.33,   // 80464（非私营在岗，旧口径最后一年）
  // —— 口径切换：2019 起全口径（元/月）——
  2020: 5772.25,   // 69267/年（全口径，统计局2019公告首次发布；同年非私营在岗86855）
  2021: 6210,      // ✅74520/年 全口径（内江PDF全部单位列）
  2022: 6785,      // ✅81420/年 全口径（内江PDF全部单位列）
  2023: 7076,      // ✅84912/年 全口径（内江PDF全部单位列）
  2024: 7518.33,   // ✅90220/年 全口径（川人社办发〔2024〕48号）
  2025: 7646,      // ✅91752/年 全口径（川人社办发〔2025〕39号）
  2026: 7831,   // 2025年统计口径社平（2026年度执行）
  // 2025: 官方全口径未公布，交由引擎预发年规则外推(=2024原值)，公布后再填
};
...
// 建账时间（个人账户制度建立时间）
// 官方依据: 津政发〔1994〕92号(1994-12-23) "自本办法实施之日起建立职工基本养老保险个人帐户制度"
//   天津市社保中心《天津社会保险》2009年第1期确认"1994年10月正式建立养老保险个人账户"(置信度高)
// 注: 天津过渡性养老金年限按"1997年底前"计算(见TRANS_COEF注释), 与建账日1994-10分离,
//   故 CUTOFF_DATE 保持 1997-12 不动(政策口径), 仅 ACCOUNT_START 订正为真实建账日。
const ACCOUNT_START = { year: 1994, month: 10 }
const CUTOFF_DATE   = { year: 1997, month: 12 }
...
const AVG_SALARY_HISTORY = {
  ...
  1990: 146.42,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1991: 146.42,
  1992: 153.75,
  ...
  2018: 7073,
  2019: 7540,
  2020: 6323,   // 2020全口径切换前最后一年(在岗职工口径)；2019<2018为口径切换下凹
  2021: 6777,   // 2020起全口径城镇单位就业人员平均工资(与PROV_BASE计发基数脱钩)
  2022: 7478,
  2023: 7919,
  2024: 8355,
  2025: 8540,   // 2024全口径社平=计算2025缴费指数分母(用户表注明)
  // [V2已删] 2025: 8861,   // 2025年度社保缴费基数(外推，待官方公布)
  2026: 8634,   // 2025年统计口径社平（2026年度执行）
};
...
// 新疆维吾尔自治区养老金计算模块
// TODO：补充1995-2022年官方计发基数(PROV_BASE)待核（2023-2025已核：7625/7750/8448；社平AVG已官方确认2026-07-18）

// ==================== 计发基数 ====================
// 【时间标记核验 2026-07-23】新疆计发基数（元/月）：规则≈省加权公布值（PROV_BASE[2024]=7750 ≠ AVG[2023]=8332，非简单"上年社平"；仅PROV_BASE[2025]=8448=AVG[2024]）
//   ✅ 2023-2025：官方确认(新人社函〔2025〕168号)+MD一致(7625/7750/8448)
//   ⚠️ 1978-2022：暂存值待官方逐核（文件头已注），MD 无历年计发基数表
const PROV_BASE = {
  1978: 883,
  1979: 927,
  1980: 974,
...
// 【时间标记核验 2026-07-23】新疆社平(AVG_SALARY_HISTORY,元/月)：✅ 1995-2024 与 MD 表逐值吻合(445.67…8448，2026-07-18用户官方表核对；2023=8332/2024=8448=2025计发基数)。注：PROV_BASE[2024]=7750≠AVG[2023]=8332 为新疆计发基数口径特殊，非错误
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1995: 445.67,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1996: 445.67,
  1997: 498.92,
  1998: 546.5,
  1999: 569.75,
  ...
  2021: 6531,
  2022: 7089,
  2023: 7625.08,  // 91501元/年÷12=7625.08（用户提供官方表，2026-07-18确认）
  2024: 8332,
  2025: 8448,
  2026: 8744,   // 2025年统计口径社平（2026年度执行）
  // 2025: 官方全口径未公布，交由引擎预发年规则外推(=2024原值)，公布后再填
};
...
// 西藏自治区养老金计算模块
// 数据状态（2026-07-23 时间标记核验）：PROV_BASE 2005-2025 与 AVG 同值（西藏当年口径，社保核验表逐行确认✅）；1978-2004 为平滑外推占位（西藏2000年才建账，1978-1999 实际无真实数据，仅作连续外推），待官方补充可替换。

// ==================== 计发基数 ====================

// 【时间标记核验 2026-07-23】PROV_BASE
// ✅ 已核(社保核验表逐行确认，2025-12-10出具)：2005:1550 / 2006:2300 / 2007:2500 / 2008:2800 / 2009:2900 / 2010:3000 / 2011:3200 / 2012:3500 / 2013:3600 / 2014:4000 / 2015:5100 / 2016:5929 / 2017:6708 / 2018:7587 / 2019:7815 / 2020:8143 / 2021:8839 / 2022:9900 / 2023:10791 / 2024:11546 / 2025:11777
//    注：西藏当年口径 → PROV_BASE[Y]=AVG[Y]=当年社平÷12，故 2005-2025 与下方 AVG 完全一致（2004前为外推占位，见下 📋）。
// 📋 占位(平滑外推，非官方)：1978:1224 … 2004:4352（西藏2000才建账，1978-1999 真实无数据，仅维持序列连续）
// ⚠️ 特殊口径：PROV_BASE[2024]=11546 与多数省"=上年社平"不同，此处=2024当年社平÷12（与 AVG[2024] 同值），由多张官方核定表交叉验证。
// BASE_PARAMS.PROV_2025=11777 已与 PROV_BASE[2025] 一致（西藏当年口径）。
const PROV_BASE = {
  1978: 1224,
  1979: 1285,
  1980: 1349,
...
// 【时间标记核验 2026-07-23】AVG_SALARY_HISTORY
// ✅ 已核(西藏社保核验表逐行确认 2025-12-10 + 1998-2004 统计局官方截图)：1998:915.58 / 1999:1080.17 / 2000:1248 / 2001:1595.33 / 2002:2063.83 / 2003:2244.25 / 2004:2572.75 / 2005:1550 … 2025:11777（2005-2025 见下方 ✅ 行内标记，逐行置信）
// 📋 无更早数据：1998 年前无官方社平序列（西藏建账/统计体系晚），不编占位（符合"年表起点=建账年"红线）。
// ⚠️ 口径：西藏为「当年」口径，槽位Y存Y年度真实月均值（元/年÷12），与 PROV_BASE 同序；区别于多数省"AVG=上年社平"映射。
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  ...
  2026: 11954,   // 2025年统计口径社平（2026年度执行）
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1995: 429,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1996: 429,
  1997: 519,
  1998: 586,
  1999: 639,
  ...
  2024: 7177,
  2025: 7263,
  // [V2已删] 2025: 7427,  // 2025年计发基数尚未公布，预发暂用2024年基数8183
  2026: 7339,   // 2025年统计口径社平（2026年度执行）
};
...
(function () {
  var module = { exports: {} };
  var exports = module.exports;
// 数据来源：✅ 已据官方核定表核实（浙人社发〔2018〕102号等；官方核定表 2026-07 核定，引擎校验通过）
// 2024年计发基数：8310元/月
// 更新时间：2026-06-10
...
// SALARY_SEMANTICS_V2: avg_salary_history[Y] = Y 年度执行社平（= Y-1 统计年），2026-09-20 统一
const AVG_SALARY_HISTORY = {
  1992: 240.33,   // 首端兜底：早于数据起始年的参保年份取最早已知值（SALARY_SEMANTICS_V2）
  1993: 240.33,
  1994: 327.67,
  1995: 466.42,
  1996: 551.58,
  ...
  2024: 8310.17,
  2025: 8432.83,
  // [V2已删] 2025: 8746,  // 2025年度社保缴费基数·2024全口径社平（官方已发布，人社通汇总）
};
